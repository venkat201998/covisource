                ...
                <div className="col-lg-8 col-10 offset-lg-2 p-md-4 p-3 text-center shadow">
                    ...
                    <form onSubmit={handleSubmit} className="container-fluid" >
                                ...
                                <div className="form-group my-xl-5 my-3 row">
                                    ...
                                    <div className="col-md-8 col-12 mb-3 mb-md-1">
                                        <select className="w-100 h-100 form-select" id="state" aria-label="Default select example" required onChange={(e)=> setState(e.target.value) }>
                                ...
                                <div className="form-group my-xl-5 my-3 row">
                                    ...
                                    <div className="col-md-8 col-12 mb-3 mb-md-1">
                                        <select className="w-100 h-100 form-select" id="city" aria-label="Default select example" required onChange={(e)=> setCity(e.target.value) }>
                                ...
                                <div className="form-group row">
                                    <div className="col-md-4 col-6 offset-md-3 text-start">
                                        <button type="submit" className="btn btn-raised btn-outline-success fw-bold">Register</button>
                                    </div>
                                </div>
                        </form>
                </div>
